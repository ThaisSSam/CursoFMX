  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#090d16] p-4 font-sans">
      <div className="w-full max-w-md bg-[#0f172a]/60 border border-slate-800/80 rounded-2xl p-8 backdrop-blur-sm shadow-2xl flex flex-col items-center">
        ...
        <Key className="text-white rotate-180"/>
        </div>
        ...
        <form onSubmit={handleRecuperar} className="w-full flex flex-col gap-4">
          <div>
            ...
            <div className="relative flex items-center">
              ...
              <input
                type="email"
                className="w-full p-2.5 pl-8 border border-slate-800 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none bg-[#131c31] text-white text-sm transition-all"
                value={email}
          ...
          <Button
            type="submit"
            className="w-full bg-[#3b82f6] hover:bg-blue-600 text-white p-2.5 rounded-lg font-semibold text-sm transition-colors mt-2 shadow-lg shadow-blue-500/20 cursor-pointer"
          >
        ...
        <div className="w-full mt-6 p-4 pl-2.5 border border-slate-800/60 rounded-xl bg-[#192440]/40 flex items-start gap-3">
